set_property SRC_FILE_INFO {cfile:/home/xyin/Embedded_System_Lab/Lab2_2/Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_processing_system7_0_0/tutorial_processing_system7_0_0.xdc rfile:../../../Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_processing_system7_0_0/tutorial_processing_system7_0_0.xdc id:1 order:EARLY scoped_inst:tutorial_i/processing_system7_0/inst} [current_design]
set_property SRC_FILE_INFO {cfile:/home/xyin/Embedded_System_Lab/Lab2_2/Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_clk_wiz_0_0/tutorial_clk_wiz_0_0.xdc rfile:../../../Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_clk_wiz_0_0/tutorial_clk_wiz_0_0.xdc id:2 order:EARLY scoped_inst:tutorial_i/clk_wiz_0/inst} [current_design]
set_property SRC_FILE_INFO {cfile:/home/xyin/Embedded_System_Lab/Lab2_2/Lab2_2.srcs/constrs_1/imports/constraints/zedboard_hdmi_display.xdc rfile:../../../Lab2_2.srcs/constrs_1/imports/constraints/zedboard_hdmi_display.xdc id:3} [current_design]
set_property SRC_FILE_INFO {cfile:/home/xyin/Embedded_System_Lab/Lab2_2/Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_v_axi4s_vid_out_0_0/tutorial_v_axi4s_vid_out_0_0_clocks.xdc rfile:../../../Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_v_axi4s_vid_out_0_0/tutorial_v_axi4s_vid_out_0_0_clocks.xdc id:4 order:LATE scoped_inst:tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst} [current_design]
set_property SRC_FILE_INFO {cfile:/home/xyin/Embedded_System_Lab/Lab2_2/Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_v_tc_0_0/tutorial_v_tc_0_0_clocks.xdc rfile:../../../Lab2_2.srcs/sources_1/bd/tutorial/ip/tutorial_v_tc_0_0/tutorial_v_tc_0_0_clocks.xdc id:5 order:LATE scoped_inst:tutorial_i/zed_hdmi_display/v_tc_0/U0} [current_design]
...
set_max_delay -from [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst/vid_io_out_clk]] -to [all_registers -clock [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst/aclk]]] -datapath_only [expr min([join [get_property PERIOD [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst/vid_io_out_clk]]] ,])]
set_property src_info {type:SCOPED_XDC file:4 line:11 export:INPUT save:INPUT read:READ} [current_design]
set_max_delay -from [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst/aclk]] -to [all_registers -clock [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst/vid_io_out_clk]]] -datapath_only [expr min([join [get_property PERIOD [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_axi4s_vid_out_0/inst/aclk]]] ,])]
set_property src_info {type:SCOPED_XDC file:5 line:6 export:INPUT save:INPUT read:READ} [current_design]
set_max_delay -from [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_tc_0/U0/clk]] -to [all_registers -clock [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_tc_0/U0/s_axi_aclk]]] -datapath_only [expr min([join [get_property PERIOD [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_tc_0/U0/clk]]] ,])]
set_property src_info {type:SCOPED_XDC file:5 line:7 export:INPUT save:INPUT read:READ} [current_design]
set_max_delay -from [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_tc_0/U0/s_axi_aclk]] -to [all_registers -clock [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_tc_0/U0/clk]]] -datapath_only [expr min([join [get_property PERIOD [get_clocks -of_objects [get_pins tutorial_i/zed_hdmi_display/v_tc_0/U0/s_axi_aclk]]] ,])]
